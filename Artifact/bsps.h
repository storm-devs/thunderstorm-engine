...
public:
	...
	// nodes --------------------------------------------------------
	BSPS_PS * GetLeftNode();
	BSPS_PS * GetRightNode();
	void SetLeftNode(BSPS_PS * node);
	void SetRightNode(BSPS_PS * node);
	void AttachTo(BSPS_PS * link_after_PTR,BSPS_PS * * Root,BSPS_PS * * Top);
	void Attach(BSPS_PS * * Root,BSPS_PS * * Top);
	void Deattach(BSPS_PS * * Root,BSPS_PS * * Top);
	void ProcessOrder(BSPS_PS * * Root,BSPS_PS * * Top);
	//---------------------------------------------------------------
