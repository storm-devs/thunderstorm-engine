...
#define TEXTURE_FILE_TXEXT       ".tx"
#define TEXTURE_FILE_TXEXT_FULL  ".tga.tx"
...
class VRENDER : public SERVICE
{
public:
	// RENDER: Construct/Destruct
		virtual ~VRENDER() {};
	...
	// RENDER: Textures Section
		//virtual long TextureCreate(const long lnum) = 0;
	...
	// RENDER: Fonts Section
		...
		virtual long StringWidth(char * string, long nFontNum=0, float fScale=1.0f, long scrWidth=0) = 0;
		virtual long CharWidth(char ch, long nFontNum=0, float fScale=1.0f, long scrWidth=0) = 0;
	...
	// RENDER: Vertex/Index Buffers Section
		...
		//virtual void	FillSpriteVertex(RS_SPRITE & pV, float x, float y, float z = 1.0f, dword dwColor = 0xFFFFFF, float tu = 0.0f, float tv = 0.0f) = 0;
