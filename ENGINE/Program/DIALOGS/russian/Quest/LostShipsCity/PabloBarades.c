...
#include "TEXT\DIALOGS\Quest\LostShipsCity\PabloBarades.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		//поиск товаров на корвет
		case "SeekGoods":
			dialog.text = NPCStringReactionRepeat(DLG_TEXT_LSC[112], 
				DLG_TEXT_LSC[113], 
				DLG_TEXT_LSC[114],
                DLG_TEXT_LSC[115], "block", 0, npchar, Dialog.CurrentNode);
			link.l1 = HeroStringReactionRepeat(DLG_TEXT_LSC[116], 
				DLG_TEXT_LSC[117],
                DLG_TEXT_LSC[118], 
				DLG_TEXT_LSC[119], npchar, Dialog.CurrentNode);
