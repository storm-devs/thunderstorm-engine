...
// в игру не вошли, но как только откроются скрипты будет кладезь для аддонщиков.
// Проьба - добавлять свои титры, оставлять оригинальных авторов.
// Делалось для КВЛ, поэтому актуальности для ГПК нет
float fNewPos;
#define MAX_LINE         143
