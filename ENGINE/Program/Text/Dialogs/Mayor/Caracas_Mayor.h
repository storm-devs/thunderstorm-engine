string DLG_TEXT_MR [18] = {
	...
	"You've captured the city. What do you want?",
	"I'm acting on behalf of Governor-General of Jamaica, sir Thomas Modyford, on the basis of a privateer's patent issued to me by the Jamaican Council.",
	"And?",
	"From hereon, the city of Caracas belongs to the British Crown. The population is to pay all the tax levies, sales duties and the like, to the new British administration.",
};
