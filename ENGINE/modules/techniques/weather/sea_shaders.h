#define SEA2FOAM_VERTEX_SHADER asm { \
	vs_1_1 \
	dcl_position v0 \
	dcl_normal v1 \
	dcl_texcoord v2 \
...
#define SEA2FOAM_PIXEL_SHADER asm { \
	ps_1_4 \
	texcrd r0.rgb, t0 \
	texcrd r1.rgb, t1 \
	texcrd r2.rgb, t2 \
...
#define SEA2SUNROAD_VERTEX_SHADER asm { \
	vs_1_1 \
	dcl_position v0 \
	dcl_normal v1 \
	dcl_texcoord v2 \
