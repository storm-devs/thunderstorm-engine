...
void WideScreen::Realize(dword delta_time)
{
	...
	buf[1].x =  0.0f;  buf[1].y =  hg;    buf[1].z =  0.5f;  buf[1].rhw =  1.0f;
	buf[2].x =  w;     buf[2].y =  0.0f;  buf[2].z =  0.5f;  buf[2].rhw =  1.0f;
	buf[3].x =  w;     buf[3].y =  0.0f;  buf[3].z =  0.5f;  buf[3].rhw =  2.0f;
	buf[4].x =  0.0f;  buf[4].y =  hg;    buf[4].z =  0.5f;  buf[4].rhw =  2.0f;
	buf[5].x =  w;     buf[5].y =  hg;    buf[5].z =  0.5f;  buf[5].rhw =  2.0f;
	buf[6].x =  0.0f;  buf[6].y =  h-hg;  buf[6].z =  0.5f;  buf[6].rhw =  2.0f;
	buf[7].x =  0.0f;  buf[7].y =  h;     buf[7].z =  0.5f;  buf[7].rhw =  2.0f;
	buf[8].x =  w;     buf[8].y =  h-hg;  buf[8].z =  0.5f;  buf[8].rhw =  2.0f;
	buf[9].x =  w;     buf[9].y =  h-hg;  buf[9].z =  0.5f;  buf[9].rhw =  2.0f;
	buf[10].x = 0.0f;  buf[10].y = h;     buf[10].z = 0.5f;  buf[10].rhw = 2.0f;
	buf[11].x = w;     buf[11].y = h;     buf[11].z = 0.5f;  buf[11].rhw = 2.0f;
