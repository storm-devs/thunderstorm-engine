  ...
  if (nUsedTQ > 0) {
    ...
    if (nStartT + nUsedTQ <= MAX_BLOOD_TRIANGLES) {
      ...
      pRS->DrawPrimitiveUP(D3DPT_TRIANGLELIST, D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_TEX1,
                           MAX_BLOOD_TRIANGLES - nStartT, static_cast<void*>(&pvBloodT[nStartT]), sizeof(BloodVertex),
                           "Blood");
      pRS->DrawPrimitiveUP(D3DPT_TRIANGLELIST, D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_TEX1,
                           nStartT + nUsedTQ - MAX_BLOOD_TRIANGLES, static_cast<void*>(pvBloodT), sizeof(BloodVertex),
                           "Blood");
    }
