...
#ifndef _XBOX
  if (api->Controls->GetDebugAsyncKeyState('6') < 0) fScale -= static_cast<float>(Delta_Time) * 0.001f * 0.5f;
  if (api->Controls->GetDebugAsyncKeyState('7') < 0) fScale += static_cast<float>(Delta_Time) * 0.001f * 0.5f;
