...
bool CXI_PICTURE::Init(INIFILE* ini1, const char * name1, INIFILE* ini2, const char * name2, VDX9RENDER* rs, XYRECT& hostRect,
                       XYPOINT& ScreenSize)
{
...
void CXI_PICTURE::ReleasePicture()
{
	...
	if (m_pD3D8Texture) m_pD3D8Texture->Release();
	m_pD3D8Texture = nullptr;
