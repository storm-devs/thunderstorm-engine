...
bool CAviPlayer::PlayMedia(char* fileName)
{
	...
	v[0].pos.x = (float)dstRect.left;
	v[0].pos.y = (float)dstRect.top;
	v[0].tu = 0.f;
	v[0].tv = 0.f;
	v[1].pos.x = (float)dstRect.left;
	v[1].pos.y = (float)dstRect.bottom;
	v[1].tu = 0.f;
	v[1].tv = (float)lockRect.bottom / AVI_GetTextureSize(srcHeight);
	v[2].pos.x = (float)dstRect.right;
	v[2].pos.y = (float)dstRect.top;
	v[2].tu = (float)lockRect.right / AVI_GetTextureSize(srcWidth);
	v[2].tv = 0.f;
	v[3].pos.x = (float)dstRect.right, v[3].pos.y = (float)dstRect.bottom;
	v[3].tu = (float)lockRect.right / AVI_GetTextureSize(srcWidth);
	v[3].tv = (float)lockRect.bottom / AVI_GetTextureSize(srcHeight);
