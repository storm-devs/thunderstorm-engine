...
public:
	...
	QUEST_FILE_READER* QuestFileReader() override { return pQuestService; }
	VXSERVICE* PictureService() override { return pPictureService; }
	VSTRSERVICE* StringService() override { return pStringService; }
	VDX9RENDER* RenderService() override { return pRenderService; }

	void* GetCurrentNode() override { return m_pCurNode; }
	FXYPOINT GetMousePoint() override { return FXYPOINT(fXMousePos + m_lXMouse, fYMousePos + m_lYMouse); }
