...
bool DATA::Convert(S_TOKEN_TYPE type) {
  ...
  case VAR_INTEGER:
    ...
    case VAR_PTR: Data_type = type;
      pValue = lValue;
      return true;
    case VAR_FLOAT: Data_type = type;
    ...
    case VAR_STRING:
      ...
      Set(buffer);
      return true;
    default: Error(INVALID_CONVERSATION);
      return false;
    }
    break;
  case VAR_FLOAT:
    switch (type) {
    case VAR_INTEGER: Data_type = type;
...
bool DATA::CompareAndSetResult(DATA* pV, S_TOKEN_TYPE op) {
  ...
  case VAR_INTEGER:
    ...
    case VAR_INTEGER:
      ...
      case OP_BOOL_EQUAL:
        if (lValue == pV->lValue) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
        break;
      case OP_GREATER:
        if (lValue > pV->lValue) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
      ...
      case OP_NOT_EQUAL:
        ...
        break;
      case OP_BOOL_AND:
        if (lValue != 0 && pV->lValue != 0) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
        break;
      case OP_BOOL_OR:
        if (lValue != 0 || pV->lValue != 0) Set(static_cast<long>(1));
    ...
    case VAR_FLOAT:
      switch (op) {
      case OP_BOOL_EQUAL:
        if (lValue == pV->fValue) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
        break;
      case OP_GREATER:
        if (lValue > pV->fValue) Set(static_cast<long>(1));
      ...
      case OP_NOT_EQUAL:
        ...
        break;
      case OP_BOOL_AND:
        if (lValue != 0 && pV->fValue != 0) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
        break;
      case OP_BOOL_OR:
        if (lValue != 0 || pV->fValue != 0) Set(static_cast<long>(1));
  ...
  case VAR_FLOAT:
    ...
    case VAR_INTEGER:
      switch (op) {
      case OP_BOOL_EQUAL:
        if (fValue == pV->lValue) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
        break;
      case OP_GREATER:
        if (fValue > pV->lValue) Set(static_cast<long>(1));
      ...
      case OP_NOT_EQUAL:
        ...
        break;
      case OP_BOOL_AND:
        if (fValue != 0 && pV->lValue != 0) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
        break;
      case OP_BOOL_OR:
        if (fValue != 0 || pV->lValue != 0) Set(static_cast<long>(1));
    ...
    case VAR_FLOAT:
      switch (op) {
      case OP_BOOL_EQUAL:
        if (fValue == pV->fValue) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
        break;
      case OP_GREATER:
        if (fValue > pV->fValue) Set(static_cast<long>(1));
      ...
      case OP_NOT_EQUAL:
        ...
        break;
      case OP_BOOL_AND:
        if (fValue != 0 && pV->fValue != 0) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
        break;
      case OP_BOOL_OR:
        if (fValue != 0 || pV->fValue != 0) Set(static_cast<long>(1));
  ...
  case VAR_STRING:
    ...
    case VAR_STRING:
      ...
      case OP_BOOL_EQUAL:
        ...
        if (_stricmp(sValue, pV->sValue) == 0) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
        break;
      case OP_GREATER:
        if (sValue == nullptr || pV->sValue == nullptr) {
        ...
        if (strlen(sValue) > strlen(pV->sValue)) Set(static_cast<long>(1));
        else Set(static_cast<long>(0));
        break;
      case OP_GREATER_OR_EQUAL:
        if (sValue == nullptr || pV->sValue == nullptr) {
...
bool DATA::BoolConvert() {
  ...
  switch (Data_type) {
  case VAR_INTEGER:
    if (lValue != 0) Set(static_cast<long>(1));
    else Set(static_cast<long>(0));
    break;
  case VAR_FLOAT:
    if (fValue != 0) Set(static_cast<long>(1));
    else Set(static_cast<long>(0));
    break;
  case VAR_STRING:
    if (sValue == nullptr) {
    ...
    break;
  case VAR_PTR:
    if (pValue != 0) Set(static_cast<long>(1));
    else Set(static_cast<long>(0));
    break;
  default:
