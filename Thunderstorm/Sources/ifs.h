...
public:
	...
	bool ReadString(SEARCH_DATA * sd, const char * section_name, const char * key_name, char * buffer, uint32_t buffer_size, const char * def_string);
	void ReadString(SEARCH_DATA * sd, const char * section_name, const char * key_name, char * buffer, uint32_t buffer_size); // rise exception on fault
	bool ReadStringNext(SEARCH_DATA * sd, const char * section_name, const char * key_name, char * buffer, uint32_t buffer_size);
