  ...
  if (CDebug.SourceView)
    ...
    case WM_KEYDOWN:
      ...
      case 'C':
        ...
        if (OpenClipboard(nullptr)) //hwnd))
        {
          ...
          dwBytes = abs(
              static_cast<long>(CDebug.SourceView->nEndSelection) - static_cast<long>(CDebug.SourceView->nStartSelection
              )) +
            1;
    ...
    case WM_LBUTTONDOWN:
      ...
      if (aline >= CDebug.SourceView->nLinesNum)
        CDebug.SourceView->nActiveLine = CDebug.SourceView->nLinesNum -
          1;
