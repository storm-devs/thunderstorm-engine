...
bool CXI_GLOWCURSOR::Init(INIFILE *ini1,char *name1, INIFILE *ini2,char *name2, VDX9RENDER *rs, XYRECT &hostRect, XYPOINT &ScreenSize)
{
...
void CXI_GLOWCURSOR::SetRectanglesToPosition(XYRECT & rectXY)
{
	...
	m_pTexVert[0].pos.x = m_pTexVert[2].pos.x = m_pTexVert[5].pos.x = m_pTexVert[11].pos.x = m_pTexVert[13].pos.x = (float)rectXY.left;
	m_pTexVert[0].pos.y = m_pTexVert[1].pos.y = m_pTexVert[5].pos.y = m_pTexVert[7].pos.y = m_pTexVert[13].pos.y = (float)rectXY.top;
