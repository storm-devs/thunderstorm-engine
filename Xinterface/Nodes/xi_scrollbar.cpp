...
void CXI_SCROLLBAR::Draw(bool bSelected,uint32_t Delta_Time)
{
	...
	if( m_MouseClickParam.bExecute ) {
		...
		} else m_MouseClickParam.bExecute = false;
	}
...
bool CXI_SCROLLBAR::Init(INIFILE *ini1,char *name1, INIFILE *ini2,char *name2, VDX9RENDER *rs, XYRECT &hostRect, XYPOINT &ScreenSize)
{
...
void CXI_SCROLLBAR::LoadIni(INIFILE *ini1,char *name1, INIFILE *ini2,char *name2)
{
	...
	m_fXShadowPress = fPnt.x;	m_fYShadowPress = fPnt.y;
