...
void CINODE::GetAbsoluteRect(XYRECT & rect,int at)
{
	...
	if(at&ABSOLUTE_BOTTOM)	rect.bottom += m_screenSize.y - m_hostRect.bottom + m_hostRect.top;
...
bool CINODE::Init(INIFILE *ini1,char *name1, INIFILE *ini2,char *name2, VDX9RENDER *rs, XYRECT &hostRect, XYPOINT &ScreenSize)
{
	...
	if( ReadIniString(ini1,name1, ini2,name2, "GlowRectangle",param,sizeof(param)-1,"") )
	{
		...
		GetDataStr(param,"llll", &m_rectUserGlowCursor.left, &m_rectUserGlowCursor.top, &m_rectUserGlowCursor.right, &m_rectUserGlowCursor.bottom);
...
XYRECT CINODE::GetIniLongRect(INIFILE *ini1,char *name1, INIFILE *ini2,char *name2, char * keyName, XYRECT & rectDefault)
{
	char param[256];
...
FXYRECT CINODE::GetIniFloatRect(INIFILE *ini1,char *name1, INIFILE *ini2,char *name2, char * keyName, FXYRECT & rectDefault)
{
	char param[256];
...
XYPOINT CINODE::GetIniLongPoint(INIFILE *ini1,char *name1, INIFILE *ini2,char *name2, char * keyName, XYPOINT & pntDefault)
{
	char param[256];
...
FXYPOINT CINODE::GetIniFloatPoint(INIFILE *ini1,char *name1, INIFILE *ini2,char *name2, char * keyName, FXYPOINT & pntDefault)
{
	char param[256];
